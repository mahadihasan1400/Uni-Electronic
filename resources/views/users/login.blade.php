                                        ...
                                        <form method="post" action = {{ route('users.save') }}>
                                         ...
                                         @endif
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control"  name="company_name" type="text" placeholder="Uni Electronic" value="{{ old('company_name') }}"/>
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control"  name="company_email" type="email" placeholder="name@example.com" value="{{ old('company_email') }}"/>
                                            ...
                                            <div class="d-flex align-items-center justify-content-center mt-4 mb-0">
                                                ...
                                                <button class="btn btn-primary"  type="submit">Join Digital Trade Fair</button>
                                            </div>
                                        </form>
                                    </div>
